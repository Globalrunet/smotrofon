...
class LocalCoursesLessonsListDataSource @Inject constructor(
    private val lessonDao: CoursesLessonDao,
    private val query: CoursesLessonsListQuery
) : PagingSource<Int, CourseLesson>() {

    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, CourseLesson> {
    ...
    override fun getRefreshKey(state: PagingState<Int, CourseLesson>): Int? {
