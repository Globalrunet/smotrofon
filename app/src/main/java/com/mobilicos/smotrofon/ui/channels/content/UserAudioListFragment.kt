...
class UserAudioListFragment : Fragment(), OnClickUserMediaListElement {

    private var binding: UserVideoListBinding? = null
    lateinit var videoViewModel: MediaViewModel
    lateinit var videoListAdapter: UserMediaListAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        videoListAdapter = UserMediaListAdapter(this)
            ...
            viewLifecycleOwner.lifecycleScope.launchWhenStarted {
                repeatOnLifecycle(Lifecycle.State.STARTED) {
                    userContentViewModel.getUserMediaListData(
                        ...
                        type = Config.TYPE_AUDIO
                    )
                        .collectLatest {
                            println("RESULT LOADING REFRESH ??? $it")
    ...
    override fun clickOnUserMediaListElement(media: Media, type: Int) {
