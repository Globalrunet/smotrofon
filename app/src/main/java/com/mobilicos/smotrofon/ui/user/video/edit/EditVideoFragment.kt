...
class EditVideoFragment : Fragment() {
    private lateinit var binding: FragmentUserVideoEditBinding
    private val viewModel: EditVideoViewModel by activityViewModels()
    private val args: EditVideoFragmentArgs by navArgs()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentUserVideoEditBinding.inflate(layoutInflater, container, false)
